...
const NationalOnlineComp: React.FC = () => {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbz2MqvSy5bij0ZiXFRcdBA4j1PlHyi-LpKE75VsHJ7018B1wtsH2VZ9r_6iCBkf7CWCKA/exec";
    ...
    <div className="page-container">
      ...
      <div className="registration-form">
        <form name="regist-form">
          ...
          <input type="hidden" name="PRICE" value="Rp. 375.000" readOnly />
...
const HeaderSection: React.FC = () => (
  <div className="header-section">
    <div className="header-content">
      ...
      <h2 className="event-title">NYBO 2026</h2>
    </div>
  </div>
);
...
const InstructionSection: React.FC = () => (
  <div className="instruction-section">
    <h3 className="instruction-title">
      HALLO PESERTA NYBO 2026, Mohon perhatikan informasi berikut ini sebelum mengisi formulir pendaftaran:
    </h3>
...
const InformasiUmumSection: React.FC = () => (
  <section className="form-section">
    ...
    <div className="field-grid">
      ...
      <div className="field-group">
        <label className="field-label">Sumber Informasi Kompetisi NYBO 2026</label>
